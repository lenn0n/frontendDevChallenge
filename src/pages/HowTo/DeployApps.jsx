		...
		<>
			<div className="d-flex justify-content-center m-4">
				<div>
					...
					<p>
						With{" "}
						<a className="text-info" href="https://firebase.google.com/docs/hosting">
							Firebase hosting
						</a>
						, you can deploy web apps - both static and dynamic content by a single command.
					</p>
					...
					<p>
						<a href="https://www.netlify.com/" className="me-2 text-danger">
							Netlify
						</a>
						supports GitHub, GitLab, and Bitbucket, it will redeploy the site just by pushing the code without manually rebuild.
					</p>
					...
					<ul>
						...
						<li>
							<p>
								Publish directory, default <code>public</code>, but it is usually <code>public, dist, build,...</code>
							</p>
						</li>
					</ul>
					...
					<p>
						With{" "}
						<a href="https://render.com/" className="me-2 text-success">
							Render
						</a>{" "}
						, you can host static sites, backend APIs, databases, and all your other apps in one place.
					</p>
					...
					<p>
						<a href="https://surge.sh/" className="me-2 text-warning">
							Surge
						</a>
						is a cloud platform to publish static web for Front-End Developers.
					</p>
					{SurgeSteps.map((data) => {
						return <Step text={data.text} code={data.code} />;
					})}
					...
					<p>
						<a href="https://vercel.com/" className="me-2 text-dark">
							Vercel
						</a>
						is a cloud platform for websites and serverless APIs, free and easy to use
					</p>
