      ...
      <div className="mt-5 d-flex flex-column gap-4 ms-4 me-4">
        <div className="d-flex flex-wrap">
          <div className="col-4 pe-2">
            <img src={G1} alt="g1" className="gp-img" height="300px"/>
          </div>
          <div className="col-8 ps-3">
            <img src={G2} alt="g2" className="gp-img" height="300px"/>
          </div>
        </div>
        <div className="d-flex">
          <div className="d-flex gap-4 flex-column col-9 pe-2">
            <div>
              <img src={G3} alt="g3" className="gp-img" height="300px"/>
            </div>
            <div className="d-flex flex-wrap">
              <div className="col-6 pe-2">
                <img src={G6} alt="g6" className="gp-img" height="300px"/>
              </div>
              <div className="col-6 ps-3">
                <img src={G5} alt="g5" className="gp-img" height="300px"/>
              </div>
            </div>
          </div>
          <div className="d-flex col-3 ps-3">
            <img src={G4} alt="g4" className="gp-img gp-img-extended"/>
          </div>
        </div>
      </div>
    </div>
