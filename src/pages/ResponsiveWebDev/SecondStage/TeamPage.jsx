    ...
    return (
      <div className="col-lg-4 col-sm-6 crew-frame">
        <div className="d-flex justify-content-center">  
          <div>
            <img src={data?.avatar} alt="photo1" className="crew-avatar"/>
        ...
        <div className="row">
            ...
            <div className="col-lg-6 col-sm-12">
              <div className="m-4">
                ...
                <div>We are team of creatively diverse.  driven.  innovative individuals working in various locations from the world.</div>
              </div>
            </div>
        </div>
        <div className="mt-5 row">
          { CrewList.map((data)=> <Crew data={data}/>)}
        </div>
      </div>
    </div>
  </>)
